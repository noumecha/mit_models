 ...
 *
 * @Layout(
 *   id = "mit_models_project_section",
 *   label = @Translation(" Mit_Models : Project Section "),
 *   category = @Translation("mit_models"),
 *   path = "layouts/sections",
 *   template = "mit_models_project_section",
 *   library = "mit_models/mit_models_project_section",
...
class MitModelsProjectSection extends FormatageModelsSection {
    ...
    public function __construct(array $configuration, $plugin_id, $plugin_definition, StylesGroupManager $styles_group_manager) {
        ...
        $this->pluginDefinition->set('icon', drupal_get_path('module', 'mit_models') . "/icones/sections/mit_models_project_section.png");
    }
